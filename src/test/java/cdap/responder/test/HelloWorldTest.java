...
public class HelloWorldTest extends TestBase {
  ...
  public void test() throws Exception {
    // Deploy the ResponderTests application
    ApplicationManager appManager = deployApplication(ResponderTests.class);
    ...
    // Start ResponderTest service and use it
    ServiceManager serviceManager = appManager.getServiceManager(ResponderTests.ResponderTest.SERVICE_NAME).start();
